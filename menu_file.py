...
file.add_command(label="New", command=new_window, accelerator="Ctrl+N")
...
# =================================================================================================
text = Text(root, font=("Calibri",20,"bold"))
text.place(x=0,y=0,width=1000,height=600)
